...
namespace ExcelReadAndWrite.StdExcelModel
{
    public abstract class StdExcelWorkSheetBase
    {
        ...
        public abstract StdExcelRangeBase GetRange();

        public abstract StdExcelCellBase GetCell(int rowNum, int columnNum);

        public abstract string GetCellFormular(int rowNum, int columnNum);
        ...
        public abstract void SetCellFormular(string formular, int rowNum, int columnNum);
